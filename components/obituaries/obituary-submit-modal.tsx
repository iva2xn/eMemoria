...
// Public submission modal — lets visitors submit an obituary for review.
// Has its own form state since it's fully self-contained.
...
export function ObituarySubmitModal({ onClose }: { onClose: () => void }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Insert obituary as unpublished — admin reviews before publishing
          ...
          {done ? (
            ...
            <div className="px-6 py-5 space-y-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Submitter info (optional — for follow-up) */}
